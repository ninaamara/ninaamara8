                        ...
                        <div class="form-group">
                             <div class="form-row">
                                 <div class="col">
                                      ...
                                      <input type="text" name="kd_makul" class="form-control" placeholder="Tambahkan Makul">
                                    </div>
                                <div class="col">
                                      <label for="">Nama Matakuliah</label>
                                      <input type="text" name="nama_makul" class="form-control" placeholder="Masukan Matakuliah">
                                    </div>
                                <div class="col">
                                      <label for="">SKS</label>
